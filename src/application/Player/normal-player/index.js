		...
		>
			<NormalPlayerContainer ref={normalPlayerRef}>
				...
				<Middle ref={cdWrapperRef} onClick={toggleCurrentState}>
					<CSSTransition classNames="fade" timeout={400} in={currentState.current !== 'lyric'}>
					...
					<CSSTransition classNames="fade" in={currentState.current === 'lyric'} timeout={400}>
						<LyricContainer>
							<Scroll ref={lyricScrollRef}>
								<LyricWrapper
									className="lyric-wrapper"
									style={{ visibility: currentState.current !== 'lyric' ? 'hidden' : 'visible' }}
								>
									{currentLyric ? (
